...
//   }
  ...
  Widget build(BuildContext context) {
    ...
    final List<Map<String, dynamic>> measurements = [
      {"name": "Chest Width", "measurementInches": 20.5, "measurementCm": inchesToCm(20.5)},
      {"name": "Body Length", "measurementInches": 28.0, "measurementCm": inchesToCm(28.0)},
      {"name": "Sleeve Length", "measurementInches": 25.0, "measurementCm": inchesToCm(25.0)},
      {"name": "Shoulder Width", "measurementInches": 18.0, "measurementCm": inchesToCm(18.0)},
    ];

    return SafeArea(
      child: Scaffold(
        appBar: AppBar(
          title: Text("Results for Size ${widget.selectedSize}", style: TextStyle(color: Colors.white),),
                      ...
                      children: [
                        ...
                        Row(
                          ...
                          children: const [
                            ...
                            Text("Inches", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
                            Text("Centimeters", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
                          ],
                        ),
                        const Divider(),
                      ...
                      ElevatedButton(
                        onPressed: () async {
                          try {
                            ...
                            await storeMeasurementData(imageFile.path, user.uid, user.email!, widget.actualSize, widget.selectedSize,'Sweatshirt Sizes');
