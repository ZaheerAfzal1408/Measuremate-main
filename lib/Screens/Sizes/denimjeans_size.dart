...
class DenimJeansSize extends StatelessWidget {
    ...
    return SafeArea(
      child: Scaffold(
        appBar: AppBar(
          ...
          title: const Text(
            "DENIM JEANS SIZE",
            style: TextStyle(color: Colors.white, fontFamily: 'CeraPro', letterSpacing: 3.5, fontWeight: FontWeight.bold),
          ),
  ...
  void _showInputDialog(BuildContext context, String selectedSize) {
    ...
    showDialog(
      ...
      builder: (context) {
        return AlertDialog(
          title: Text("Enter measurements for size $selectedSize", style: TextStyle(fontFamily: 'CeraPro'),),
          content: Column(
            ...
            children: [
              ...
              Padding(
                ...
                child: TextField(
                  ...
                  keyboardType: TextInputType.numberWithOptions(decimal: true),
                  decoration: InputDecoration(
                    labelText: "Front Rise (Ideal: ${measurements['frontRise']} cm)",
              ...
              children: [
                ...
                TextButton(
                  onPressed: () async {
                    ...
                    if (waist != null && frontRise != null && hip != null &&
                        thigh != null) {
                      Navigator.of(context).pop();
                      ScaffoldMessenger.of(context).showSnackBar(
                        const SnackBar(
                          content: Text('Measurements confirmed!', style: TextStyle(fontFamily: 'CeraPro'),),
                      ...
                      ScaffoldMessenger.of(context).showSnackBar(
                        const SnackBar(
                          content: Text('Please enter valid measurements!', style: TextStyle(fontFamily: 'CeraPro'),),
                        ),
                      );
                      Navigator.of(context).pop();
                    }
